    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS COMPANY " + "(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, " + " name VARCHAR(255) UNIQUE NOT NULL " + ")");
                statement.executeUpdate("ALTER TABLE COMPANY " + "ALTER COLUMN id RESTART WITH 1");
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS CAR " + "(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, " + " name VARCHAR(255) UNIQUE NOT NULL, " + " company_id INT NOT NULL," + " CONSTRAINT fk_company FOREIGN KEY (company_id)" + " REFERENCES COMPANY(id)" + ")");

                statement.executeUpdate("ALTER TABLE CAR " + "ALTER COLUMN id RESTART WITH 1");

                statement.executeUpdate("CREATE TABLE IF NOT EXISTS CUSTOMER " + "(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, " + " name VARCHAR(255) UNIQUE NOT NULL, " + " rented_car_id INT," + " CONSTRAINT fk_car FOREIGN KEY (rented_car_id)" + " REFERENCES CAR(id)" + ")");

                statement.executeUpdate("ALTER TABLE CUSTOMER " + "ALTER COLUMN id RESTART WITH 1");

                statement.executeUpdate("ALTER TABLE CUSTOMER " + "ALTER rented_car_id SET DEFAULT NULL");
